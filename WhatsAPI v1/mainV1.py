...
def main():
    print(list_util())
    print(ajouter_util(input('Quelle pseudonyme souhaiter vous utiliser ?  ')))
    print(info_util(input('Quelle est le pseudonyme de utilisateur dont vous souhaiter connaitre les information ?  ')))
