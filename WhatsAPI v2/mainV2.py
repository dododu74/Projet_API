...
def main():
    print(list_util())
    print(ajouter_util(input('Quel pseudonyme souhaiter vous utiliser ?  ')))
    print(info_util(input('Quel est le pseudonyme de utilisateur dont vous souhaiter connaitre les informations ? ')))
    pseudo_utilisateur = input('Quel est votre pseudonyme ?  ')
    pseudo_utilisateur_a_ajouter = input('Quel est le pseudonyme de utilisateur avec lequel vous souhaiter être amis ? ')
    print(ajouter_amis(pseudo_utilisateur, pseudo_utilisateur_a_ajouter))
    print(voir_amis(input('Quel est le pseudonyme de utilisateur dont vous souhaiter voir les amis ? ')))
    pseudo_utilisateur = input('Quel est votre pseudonyme ?  ')
    pseudo_utilisateur_a_sup = input('Quel est le pseudonyme de utilisateur avec lequel vous souhaiter ne plus être amis ? ')
    print(supprimer_amis(pseudo_utilisateur, pseudo_utilisateur_a_sup))
    print(voir_amis(pseudo_utilisateur))
